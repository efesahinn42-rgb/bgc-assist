...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'Bayi Girişi' (Dealer Login) to proceed to admin login.
        ...
        try:
            ...
            raise AssertionError('Test case failed: Admin users could not create, read, update, or delete road assistance packages as required by the test plan.')
